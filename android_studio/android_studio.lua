...
function m.generate_cmake_lists(prj)
    ...
    for _, libdir in ipairs(cfg.libdirs) do
        ...
        if links then
            for i, value in ipairs(links) do
                if ends_with(value, ".jar") == false and ends_with(value, ".aar") == false then
                    linker_options = linker_options .. " " .. value
                end
            end
        end
